...
function loadDishesFromDB(path) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    array = _a.sent();
                    return [2 /*return*/, JSON.parse(array)];
            }
        });
    });
}
var dishes = await loadDishesFromDB("http://localhost:2137/dishes");
...
if (total_amount) {
    var sum_1 = 0;
    items_in_cart.forEach(function (element) {
        sum_1 += element[1] * dishes[Number(element[0])].price;
    });
    if (sum_1 !== 0) {
